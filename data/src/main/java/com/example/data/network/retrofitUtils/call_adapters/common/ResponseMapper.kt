package com.example.data.network.retrofitUtils.call_adapters.common

import com.example.data.network.retrofitUtils.network.errors.ApiError
import com.example.data.network.retrofitUtils.network.errors.NetworkError
import com.example.data.network.retrofitUtils.network.errors.UnknownResponseError
